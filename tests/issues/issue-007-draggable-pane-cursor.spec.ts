...
/**
 * Issue #7: Draggable Pane sticks to cursor when dragging operation is
 * interrupted https://github.com/kitschpatrol/svelte-tweakpane-ui/issues/7
 *
 * When dragging a pane and the operation is interrupted (e.g., Alt+Tab), the
 * pane would stick to the cursor. This was fixed by adding a pointercancel
 * event listener.
 */
