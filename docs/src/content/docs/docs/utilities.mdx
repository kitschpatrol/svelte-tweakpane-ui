...
The `Utils.cubicBezierToEaseFunction()` creates easing functions from cubic bezier values that are ready for use with Svelte's tween stores and related animation systems.
