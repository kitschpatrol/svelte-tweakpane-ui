...
So "Plugin" in _Svelte Tweakpane UI_ indicates the _provenance_ of a component, but doesn't change how it's used.
...
Many of the most popular Tweakpane plugins are already bundled with _Svelte Tweakpane UI_, and have been "wrapped" according to the conventions of the library. Plugins _**not**_ currently bundled with the _Svelte Tweakpane UI_ library **will not work** seamlessly unless they are explicitly wrapped.
