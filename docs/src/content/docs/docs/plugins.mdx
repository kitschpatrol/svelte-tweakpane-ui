...
| [Color Plus](https://github.com/kitschpatrol/tweakpane-plugin-color-plus)  | `<ColorPlus>`                                                                    | _(First-party)_                                                        |
...
Each of the included third-party Tweakpane plugins has been forked to incorporate build process tweaks that dramatically reduce the final bundle size of projects using _Svelte Tweakpane UI_.
...
- [tweakpane-media](https://github.com/vyvu99/tweakpane-media) <InlineImage alt="Tweakpane Logo" src="/svelte-tweakpane-ui/tweakpane-logo.svg" />v3
