...
It takes a bit of extra code and reasoning to create the `PARAMS` object, manage binding, listen for update events, component lifecycle, place the control in the DOM, etc.
